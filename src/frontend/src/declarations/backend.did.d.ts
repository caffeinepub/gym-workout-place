...
export interface _SERVICE {
  'callNow' : ActorMethod<[string], undefined>,
  'getAddress' : ActorMethod<[], string>,
  'getAllSubmissions' : ActorMethod<[], Array<ContactSubmission>>,
  'getOpeningHours' : ActorMethod<[], string>,
  'getPhoneNumber' : ActorMethod<[], string>,
  'initiateWhatsApp' : ActorMethod<[string], undefined>,
  'openGoogleMaps' : ActorMethod<[string], undefined>,
