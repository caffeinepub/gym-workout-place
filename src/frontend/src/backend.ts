...
export class Backend implements backendInterface {
    ...
    async callNow(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.callNow(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async initiateWhatsApp(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initiateWhatsApp(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async openGoogleMaps(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.openGoogleMaps(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
